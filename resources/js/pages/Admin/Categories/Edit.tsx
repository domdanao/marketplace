                                    ...
                                    <div className="grid grid-cols-1 gap-6">
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                Current slug: <code className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">{category.slug}</code>
                                            </p>
                                        </div>
                                ...
                                <div className="mb-8 border-t border-gray-200 dark:border-gray-700 pt-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                            ...
                                            <div className={`text-lg font-semibold ${category.is_active ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
